...
if __name__=="__main__":
    ...
    default_image_name = user_name + '-omg'
    parser = argparse.ArgumentParser()
    parser.add_argument("-i", "--image", type=str,
                        help="(required) name of the image that this container is derived from", default=default_image_name)

    parser.add_argument("-c", "--container", type=str, default="omg", help="(optional) name of the container")
    ...
    # bindings
    cmd += " -v %(source_dir)s:%(home_directory)s/omg " \
