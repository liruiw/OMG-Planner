...
from .xml_reflection import core as xmlr
...
xmlr.reflect(Color, params=[xmlr.Attribute("rgba", "vector4")])
...
xmlr.reflect(Box, params=[xmlr.Attribute("size", "vector3")])
...
xmlr.reflect(
    Cylinder, params=[xmlr.Attribute("radius", float), xmlr.Attribute("length", float)]
)
...
xmlr.reflect(Sphere, params=[xmlr.Attribute("radius", float)])
...
xmlr.reflect(Collision, params=[origin_element, xmlr.Element("geometry", "geometric")])
...
xmlr.reflect(Texture, params=[xmlr.Attribute("filename", str)])
