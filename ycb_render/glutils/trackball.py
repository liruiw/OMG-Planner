...
class Trackball:
    ...
    **Usage example**:
    ...
    def __init__(self, width, height, cam_pos=[0, 0, 2.0]):
        ...
        self._trackball = _trackball.Trackball(0, 0)
        aspect = self._window_aspect * self._aspect
        self._projection = perspective(self._zoom, aspect, self._znear, self._zfar)
        self.property = {}
    ...
    def theta_delta(self, theta):
        """ Angle (in degrees) around the z axis """

        # self._trackball.theta += theta
        self._trackball._set_delta_orientation(theta, 0)
        self.property["model"] = self._trackball.model
    ...
    def phi_delta(self, phi):
        """ Angle (in degrees) around the x axis """

        # self._trackball.phi = phi
        self._trackball._set_delta_orientation(0, phi)
        self.property["model"] = self._trackball.model
    ...
    def zoom(self, value):
        ...
        self.property["projection"] = glm.perspective(
            self._zoom, aspect, self._znear, self._zfar
        )
    ...
    def on_resize(self, width, height):
        ...
        aspect = self._window_aspect * self._aspect
        self.property["projection"] = perspective(
            self._zoom, aspect, self._znear, self._zfar
        )
